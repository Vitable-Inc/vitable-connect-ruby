  ...
  module Models
    module Members
      class QualifyingLifeEventListResponse < VitableConnect::Internal::Type::BaseModel
        ...
        sig { returns(T::Array[VitableConnect::Members::QualifyingLifeEvent]) }
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T::Array[VitableConnect::Members::QualifyingLifeEvent::OrHash],
        ...
        sig do
          override.returns(
            {
              data: T::Array[VitableConnect::Members::QualifyingLifeEvent],

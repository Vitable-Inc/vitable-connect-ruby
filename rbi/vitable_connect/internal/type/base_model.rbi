    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: VitableConnect::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  VitableConnect::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  VitableConnect::Internal::Type::BaseModel::KnownField,
                  { type: VitableConnect::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: VitableConnect::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(VitableConnect::Internal::AnyHash) }
        def to_h
        end

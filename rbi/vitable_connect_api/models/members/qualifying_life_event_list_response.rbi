    ...
    module Members
      class QualifyingLifeEventListResponse < VitableConnectAPI::Internal::Type::BaseModel
        ...
        sig do
          params(
            pagination:
              VitableConnectAPI::Models::Members::QualifyingLifeEventListResponse::Pagination::OrHash
          ).void
        end
        ...
        sig do
          params(
            data:
              T::Array[VitableConnectAPI::Members::QualifyingLifeEvent::OrHash],
            pagination:
              VitableConnectAPI::Models::Members::QualifyingLifeEventListResponse::Pagination::OrHash
        ...
        sig do
          override.returns(
            {
              data: T::Array[VitableConnectAPI::Members::QualifyingLifeEvent],
              pagination:
                VitableConnectAPI::Models::Members::QualifyingLifeEventListResponse::Pagination
            }
          )

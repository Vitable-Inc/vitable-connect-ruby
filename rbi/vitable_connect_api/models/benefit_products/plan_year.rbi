    ...
    module BenefitProducts
      class PlanYear < VitableConnectAPI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              VitableConnectAPI::BenefitProducts::PlanYear::ContributionClass
            ]
          )
        end
        ...
        sig do
          params(
            ...
            contribution_classes:
              T::Array[
                VitableConnectAPI::BenefitProducts::PlanYear::ContributionClass::OrHash
              ],
            coverage_end: Date,
            coverage_start: Date,
            created_at: Time,
            ...
            plans:
              T::Array[
                VitableConnectAPI::BenefitProducts::PlanYear::Plan::OrHash
              ],
            status:
          ...
          override.returns(
            {
              ...
              open_enrollment_start_date: Date,
              plans:
                T::Array[VitableConnectAPI::BenefitProducts::PlanYear::Plan],
              status:
                VitableConnectAPI::BenefitProducts::PlanYearStatus::TaggedSymbol,
              updated_at: Time
            }
        ...
        class Plan < VitableConnectAPI::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                VitableConnectAPI::BenefitProducts::PlanYear::Plan,
                VitableConnectAPI::Internal::AnyHash
              )
            end

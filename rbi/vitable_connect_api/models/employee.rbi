...
module VitableConnectAPI
  module Models
    class Employee < VitableConnectAPI::Internal::Type::BaseModel
      ...
      sig { returns(VitableConnectAPI::Employee::Member) }
      attr_reader :member

      sig { params(member: VitableConnectAPI::Employee::Member::OrHash).void }
      attr_writer :member
      ...
      sig { returns(T.nilable(VitableConnectAPI::Employee::Address)) }
      attr_reader :address

      sig do
        params(
          address: T.nilable(VitableConnectAPI::Employee::Address::OrHash)
        ).void
      end
      attr_writer :address
      ...
      sig do
        returns(
          T.nilable(VitableConnectAPI::Employers::EmployeeClass::TaggedSymbol)
        )
      end
        ...
        override.returns(
          {
            ...
            start_date: Date,
            updated_at: Time,
            address: T.nilable(VitableConnectAPI::Employee::Address),
            employee_class:
              T.nilable(
      ...
      class Member < VitableConnectAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              VitableConnectAPI::Employee::Member,
              VitableConnectAPI::Internal::AnyHash
            )
          end
      ...
      class Address < VitableConnectAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              VitableConnectAPI::Employee::Address,
              VitableConnectAPI::Internal::AnyHash
            )
          end

  ...
  module Models
    class BenefitEligibilityPolicyAPI < VitableConnectAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            VitableConnectAPI::BenefitEligibilityPolicyAPI,
      ...
      sig do
        returns(T::Array[VitableConnectAPI::BenefitEligibilityPolicyAPI::Rule])
      end
      attr_accessor :rules
      ...
      sig do
        params(
          ...
          rules:
            T::Array[
              VitableConnectAPI::BenefitEligibilityPolicyAPI::Rule::OrHash
            ],
          updated_at: Time,
        ...
        override.returns(
          {
            ...
            name: String,
            rules:
              T::Array[VitableConnectAPI::BenefitEligibilityPolicyAPI::Rule],
            updated_at: Time,
            description: T.nilable(String),
            replaced_policy_id: T.nilable(String)
          }
      ...
      class Rule < VitableConnectAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              VitableConnectAPI::BenefitEligibilityPolicyAPI::Rule,
              VitableConnectAPI::Internal::AnyHash
            )
          end

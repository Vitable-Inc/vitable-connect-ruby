...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/vitable_connect/helpers/` and `examples/` directory.
...
require_relative "../lib/vitable_connect"
...
```ruby
gem "vitable-connect", git: "https://github.com/stainless-sdks/vitable-connect-ruby"
```
...
```ruby
gem "vitable-connect", path: "<path-to-repo>"
```

...
class VitableConnectAPI::Test::SingletonClient < VitableConnectAPI::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: VitableConnectAPI::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class VitableConnectAPI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vitable_connect_api = VitableConnectAPI::Test::SingletonClient.instance
  end

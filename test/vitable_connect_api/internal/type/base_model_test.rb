...
class VitableConnectAPI::Test::PrimitiveModelTest < Minitest::Test
  A = VitableConnectAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = VitableConnectAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend VitableConnectAPI::Internal::Type::Union
  end

  class B < VitableConnectAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      VitableConnectAPI::Internal::Type::Unknown,
      VitableConnectAPI::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => VitableConnectAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [VitableConnectAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [VitableConnectAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [VitableConnectAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = VitableConnectAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        VitableConnectAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [VitableConnectAPI::Internal::Type::Boolean, true] => true,
      [VitableConnectAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => VitableConnectAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        VitableConnectAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = VitableConnectAPI::Internal::Type::Converter.new_coerce_state
      VitableConnectAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        VitableConnectAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class VitableConnectAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include VitableConnectAPI::Internal::Type::Enum
...
class VitableConnectAPI::Test::CollectionModelTest < Minitest::Test
  A1 = VitableConnectAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = VitableConnectAPI::Internal::Type::HashOf[Integer]

  A2 = VitableConnectAPI::Internal::Type::ArrayOf[H1]
  H2 = VitableConnectAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = VitableConnectAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = VitableConnectAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class VitableConnectAPI::Test::BaseModelTest < Minitest::Test
  class M1 < VitableConnectAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < VitableConnectAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < VitableConnectAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, VitableConnectAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = VitableConnectAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = VitableConnectAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(VitableConnectAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue VitableConnectAPI::Errors::ConversionError => e
...
class VitableConnectAPI::Test::UnionTest < Minitest::Test
  class U0
    include VitableConnectAPI::Internal::Type::Union
  ...
  class M2 < VitableConnectAPI::Internal::Type::BaseModel
  ...
  class M4 < VitableConnectAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, VitableConnectAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < VitableConnectAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, VitableConnectAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class VitableConnectAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include VitableConnectAPI::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [VitableConnectAPI::Internal::Type::Unknown, VitableConnectAPI::Internal::Type::Unknown] => true,
      [VitableConnectAPI::Internal::Type::Boolean, VitableConnectAPI::Internal::Type::Boolean] => true,
      [VitableConnectAPI::Internal::Type::Unknown, VitableConnectAPI::Internal::Type::Boolean] => false,
...
class VitableConnectAPI::Test::MetaInfoTest < Minitest::Test
  A1 = VitableConnectAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = VitableConnectAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]

...
class VitablePartnerAPI::Test::PrimitiveModelTest < Minitest::Test
  A = VitablePartnerAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = VitablePartnerAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend VitablePartnerAPI::Internal::Type::Union
  end

  class B < VitablePartnerAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      VitablePartnerAPI::Internal::Type::Unknown,
      VitablePartnerAPI::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => VitablePartnerAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [VitablePartnerAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [VitablePartnerAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [VitablePartnerAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = VitablePartnerAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        VitablePartnerAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [VitablePartnerAPI::Internal::Type::Boolean, true] => true,
      [VitablePartnerAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => VitablePartnerAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        VitablePartnerAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = VitablePartnerAPI::Internal::Type::Converter.new_coerce_state
      VitablePartnerAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        VitablePartnerAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class VitablePartnerAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include VitablePartnerAPI::Internal::Type::Enum
...
class VitablePartnerAPI::Test::CollectionModelTest < Minitest::Test
  A1 = VitablePartnerAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = VitablePartnerAPI::Internal::Type::HashOf[Integer]

  A2 = VitablePartnerAPI::Internal::Type::ArrayOf[H1]
  H2 = VitablePartnerAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = VitablePartnerAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = VitablePartnerAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class VitablePartnerAPI::Test::BaseModelTest < Minitest::Test
  class M1 < VitablePartnerAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < VitablePartnerAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < VitablePartnerAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, VitablePartnerAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = VitablePartnerAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = VitablePartnerAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(VitablePartnerAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue VitablePartnerAPI::Errors::ConversionError => e
...
class VitablePartnerAPI::Test::UnionTest < Minitest::Test
  class U0
    include VitablePartnerAPI::Internal::Type::Union
  ...
  class M2 < VitablePartnerAPI::Internal::Type::BaseModel
  ...
  class M4 < VitablePartnerAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, VitablePartnerAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < VitablePartnerAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, VitablePartnerAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class VitablePartnerAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include VitablePartnerAPI::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [VitablePartnerAPI::Internal::Type::Unknown, VitablePartnerAPI::Internal::Type::Unknown] => true,
      [VitablePartnerAPI::Internal::Type::Boolean, VitablePartnerAPI::Internal::Type::Boolean] => true,
      [VitablePartnerAPI::Internal::Type::Unknown, VitablePartnerAPI::Internal::Type::Boolean] => false,
...
class VitablePartnerAPI::Test::MetaInfoTest < Minitest::Test
  A1 = VitablePartnerAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = VitablePartnerAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]

...
class VitablePartnerAPI::Test::SingletonClient < VitablePartnerAPI::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: VitablePartnerAPI::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class VitablePartnerAPI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vitable_connect_api = VitablePartnerAPI::Test::SingletonClient.instance
  end

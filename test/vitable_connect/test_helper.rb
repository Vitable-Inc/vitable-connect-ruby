...
class VitableConnect::Test::SingletonClient < VitableConnect::Client
  include Singleton
...
class VitableConnect::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vitable_connect = VitableConnect::Test::SingletonClient.instance
  end

...
class VitableConnect::Test::PrimitiveModelTest < Minitest::Test
  A = VitableConnect::Internal::Type::ArrayOf[-> { Integer }]
  H = VitableConnect::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend VitableConnect::Internal::Type::Union
  end

  class B < VitableConnect::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      VitableConnect::Internal::Type::Unknown,
      VitableConnect::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => VitableConnect::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [VitableConnect::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [VitableConnect::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [VitableConnect::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        VitableConnect::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [VitableConnect::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [VitableConnect::Internal::Type::Boolean, true] => true,
      [VitableConnect::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => VitableConnect::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        VitableConnect::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = VitableConnect::Internal::Type::Converter.new_coerce_state
      VitableConnect::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        VitableConnect::Internal::Type::Converter.dump(target, input, state: state)
...
class VitableConnect::Test::EnumModelTest < Minitest::Test
  class E0
    include VitableConnect::Internal::Type::Enum
...
class VitableConnect::Test::CollectionModelTest < Minitest::Test
  A1 = VitableConnect::Internal::Type::ArrayOf[-> { Integer }]
  H1 = VitableConnect::Internal::Type::HashOf[Integer]

  A2 = VitableConnect::Internal::Type::ArrayOf[H1]
  H2 = VitableConnect::Internal::Type::HashOf[-> { A1 }]

  A3 = VitableConnect::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = VitableConnect::Internal::Type::HashOf[Integer, nil?: true]
...
class VitableConnect::Test::BaseModelTest < Minitest::Test
  class M1 < VitableConnect::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < VitableConnect::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < VitableConnect::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, VitableConnect::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = VitableConnect::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = VitableConnect::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(VitableConnect::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue VitableConnect::Errors::ConversionError => e
...
class VitableConnect::Test::UnionTest < Minitest::Test
  class U0
    include VitableConnect::Internal::Type::Union
  ...
  class M2 < VitableConnect::Internal::Type::BaseModel
  ...
  class M4 < VitableConnect::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, VitableConnect::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < VitableConnect::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, VitableConnect::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class VitableConnect::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include VitableConnect::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [VitableConnect::Internal::Type::Unknown, VitableConnect::Internal::Type::Unknown] => true,
      [VitableConnect::Internal::Type::Boolean, VitableConnect::Internal::Type::Boolean] => true,
      [VitableConnect::Internal::Type::Unknown, VitableConnect::Internal::Type::Boolean] => false,
...
class VitableConnect::Test::MetaInfoTest < Minitest::Test
  A1 = VitableConnect::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = VitableConnect::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]

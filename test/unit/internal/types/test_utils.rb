...
describe VitableConnect::Internal::Types::Utils do
  Utils = VitableConnect::Internal::Types::Utils

  module TestUtils
    class M < VitableConnect::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < VitableConnect::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < VitableConnect::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend VitableConnect::Internal::Types::Union
    ...
    SymbolStringHash = VitableConnect::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { VitableConnect::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = VitableConnect::Internal::Types::Array[String]
      ModelArray = -> { VitableConnect::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { VitableConnect::Internal::Types::Array[TestUtils::U] }

...
describe VitableConnect::Internal::Types::Model do
  ...
  class ExampleModel < VitableConnect::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < VitableConnect::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < VitableConnect::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < VitableConnect::Internal::Types::Model

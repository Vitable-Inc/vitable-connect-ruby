...
describe VitableConnect::Internal::Types::Union do
  class Rectangle < VitableConnect::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < VitableConnect::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < VitableConnect::Internal::Types::Model

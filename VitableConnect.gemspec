...
require_relative "lib/VitableConnect/version"
...
Gem::Specification.new do |spec|
  spec.name = "vitable-connect"
  spec.authors = ["VitableConnect"]
  spec.version = VitableConnect::VERSION
  spec.summary = "Ruby client library for the VitableConnect API"
  spec.description = "The VitableConnect Ruby library provides convenient access to the VitableConnect API from Ruby."

    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { VitablePartnerAPI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { VitablePartnerAPI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            VitablePartnerAPI::FilePart.new(value)
          in VitablePartnerAPI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in VitablePartnerAPI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [VitablePartnerAPI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: VitablePartnerAPI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in VitablePartnerAPI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in VitablePartnerAPI::Internal::Type::Converter
              ...
              VitablePartnerAPI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(VitablePartnerAPI::Internal::Type::Converter, T::Class[T.anything]) }
        end

  ...
  module Errors
    ...
    class APIStatusError < VitableConnect::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          VitableConnect::Errors::BadRequestError.new(**kwargs)
        in 401
          VitableConnect::Errors::AuthenticationError.new(**kwargs)
        in 403
          VitableConnect::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          VitableConnect::Errors::NotFoundError.new(**kwargs)
        in 409
          VitableConnect::Errors::ConflictError.new(**kwargs)
        in 422
          VitableConnect::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          VitableConnect::Errors::RateLimitError.new(**kwargs)
        in (500..)
          VitableConnect::Errors::InternalServerError.new(**kwargs)
        else
          VitableConnect::Errors::APIStatusError.new(**kwargs)
        end
      end

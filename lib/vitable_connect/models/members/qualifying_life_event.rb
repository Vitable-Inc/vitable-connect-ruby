  ...
  module Models
    module Members
      class QualifyingLifeEvent < VitableConnect::Internal::Type::BaseModel
        ...
        #   - `denied` - Denied
        #
        #   @return [Symbol, VitableConnect::Models::Members::QualifyingLifeEventStatus]
        required :status, enum: -> { VitableConnect::Members::QualifyingLifeEventStatus }
        ...
        #   {VitableConnect::Models::Members::QualifyingLifeEvent} for more details.
        #
        ...
        #
        #   @param status [Symbol, VitableConnect::Models::Members::QualifyingLifeEventStatus] - `pending` - Pending
        #

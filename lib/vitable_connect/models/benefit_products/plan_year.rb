  ...
  module Models
    module BenefitProducts
      class PlanYear < VitableConnect::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<VitableConnect::Models::BenefitProducts::PlanYear::ContributionClass>]
        required :contribution_classes,
                 -> { VitableConnect::Internal::Type::ArrayOf[VitableConnect::BenefitProducts::PlanYear::ContributionClass] }
        ...
        #
        #   @return [Array<VitableConnect::Models::BenefitProducts::PlanYear::Plan>]
        required :plans,
                 -> { VitableConnect::Internal::Type::ArrayOf[VitableConnect::BenefitProducts::PlanYear::Plan] }
        ...
        #   - `expired` - Expired
        #
        #   @return [Symbol, VitableConnect::Models::BenefitProducts::PlanYearStatus]
        required :status, enum: -> { VitableConnect::BenefitProducts::PlanYearStatus }
        ...
        #   {VitableConnect::Models::BenefitProducts::PlanYear} for more details.
        #
        ...
        #
        #   @param contribution_classes [Array<VitableConnect::Models::BenefitProducts::PlanYear::ContributionClass>] List of contribution classes defining eligibility tiers and cost structures
        #
        ...
        #
        #   @param plans [Array<VitableConnect::Models::BenefitProducts::PlanYear::Plan>] List of benefit plans available in this plan year
        #
        #   @param status [Symbol, VitableConnect::Models::BenefitProducts::PlanYearStatus] - `draft` - Draft
        #
        ...
        class ContributionClass < VitableConnect::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {VitableConnect::Models::BenefitProducts::PlanYear::ContributionClass} for more
          #   details.
          #
        ...
        class Plan < VitableConnect::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {VitableConnect::Models::BenefitProducts::PlanYear::Plan} for more details.
          #

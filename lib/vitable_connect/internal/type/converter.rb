    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { VitableConnect::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { VitableConnect::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            VitableConnect::FilePart.new(value)
          in VitableConnect::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in VitableConnect::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [VitableConnect::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: VitableConnect::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in VitableConnect::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in VitableConnect::Internal::Type::Converter
              ...
              VitableConnect::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(VitableConnect::Internal::Type::Converter, T::Class[T.anything]) }
        end

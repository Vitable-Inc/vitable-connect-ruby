  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => VitableConnect::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => VitableConnect::Internal::Util.os,
            "x-stainless-package-version" => VitableConnect::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = VitableConnect::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise VitableConnect::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if VitableConnect::Internal::Util.uri_origin(url) != VitableConnect::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, VitableConnect::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in VitableConnect::Errors::APIConnectionError | (500..)
              VitableConnect::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [VitableConnect::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = VitableConnect::Internal::Transport::PooledNetRequester.new
          ...
          @base_url_components = VitableConnect::Internal::Util.parse_uri(base_url)
          @base_url = VitableConnect::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{VitableConnect::VERSION}"
        ...
        #
        #   @option req [Class<VitableConnect::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<VitableConnect::Internal::Type::BaseStream>, nil] :stream
        #
        ...
        private def build_request(req, opts)
          ...
          path = VitableConnect::Internal::Util.interpolate_path(uninterpolated_path)

          query = VitableConnect::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = VitableConnect::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [VitableConnect::Errors::APIError]
        # @return [Array(Integer, Net::HTTPResponse, Enumerable<String>)]
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          url, headers, max_retries, timeout = request.fetch_values(:url, :headers, :max_retries, :timeout)
          input = {**request.except(:timeout), deadline: VitableConnect::Internal::Util.monotonic_secs + timeout}
          ...
          headers = VitableConnect::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in VitableConnect::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              VitableConnect::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end

            raise VitableConnect::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | VitableConnect::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param page [Class<VitableConnect::Internal::Type::BasePage>, nil]
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { VitableConnect::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          VitableConnect::RequestOptions.validate!(opts)
          ...
          headers = VitableConnect::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = VitableConnect::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            unwrapped = VitableConnect::Internal::Util.dig(decoded, unwrap)
            VitableConnect::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end

...
module VitableConnectAPI
  module Models
    # @see VitableConnectAPI::Resources::Employers#update
    class EmployerUpdateParams < VitableConnectAPI::Internal::Type::BaseModel
      ...
      #   Employer address
      #
      #   @return [VitableConnectAPI::Models::EmployerUpdateParams::Address, nil]
      optional :address, -> { VitableConnectAPI::EmployerUpdateParams::Address }, nil?: true

...
module VitableConnectAPI
  module Models
    class Enrollment < VitableConnectAPI::Internal::Type::BaseModel
      ...
      #   - `inactive` - Inactive
      #
      #   @return [Symbol, VitableConnectAPI::Models::Employees::EnrollmentStatus]
      required :status, enum: -> { VitableConnectAPI::Employees::EnrollmentStatus }
      ...
      #
      #   @return [Array<VitableConnectAPI::Models::Enrollment::EnrolledDependent>, nil]
      optional :enrolled_dependents,
               -> { VitableConnectAPI::Internal::Type::ArrayOf[VitableConnectAPI::Enrollment::EnrolledDependent] }
      ...
      #
      #   @param status [Symbol, VitableConnectAPI::Models::Employees::EnrollmentStatus] - `pending` - Pending
      #
      ...
      #
      #   @param enrolled_dependents [Array<VitableConnectAPI::Models::Enrollment::EnrolledDependent>] List of dependents included in this enrollment
      #
      ...
      class EnrolledDependent < VitableConnectAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {VitableConnectAPI::Models::Enrollment::EnrolledDependent} for more details.
        #

...
module VitableConnectAPI
  module Models
    # @see VitableConnectAPI::Resources::Employees#update
    class EmployeeUpdateParams < VitableConnectAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [VitableConnectAPI::Models::EmployeeUpdateParams::Address, nil]
      optional :address, -> { VitableConnectAPI::EmployeeUpdateParams::Address }, nil?: true

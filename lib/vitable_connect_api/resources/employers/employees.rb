    ...
    class Employers
      class Employees
        ...
        def create(employer_id, params)
          parsed, options = VitableConnectAPI::Employers::EmployeeCreateParams.dump_request(params)
          @client.request(
            method: :post,
        ...
        def list(employer_id, params = {})
          parsed, options = VitableConnectAPI::Employers::EmployeeListParams.dump_request(params)
          @client.request(
            method: :get,
            path: ["v1/employers/%1$s/employees", employer_id],
            query: parsed,

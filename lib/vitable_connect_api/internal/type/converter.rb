    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { VitableConnectAPI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { VitableConnectAPI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            VitableConnectAPI::FilePart.new(value)
          in VitableConnectAPI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in VitableConnectAPI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [VitableConnectAPI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: VitableConnectAPI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in VitableConnectAPI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in VitableConnectAPI::Internal::Type::Converter
              ...
              VitableConnectAPI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(VitableConnectAPI::Internal::Type::Converter, T::Class[T.anything]) }
        end
